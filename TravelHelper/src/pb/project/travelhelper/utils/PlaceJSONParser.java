...
public class PlaceJSONParser {
	...
	private HashMap<String, String> getPlace(JSONObject jPlace){
		...
		String latitude="";
		String longitude="";
		String rating="0", place_id="", place_ref="";
		...
		try {
			...
			place_id = jPlace.getString("id");
			place_ref = jPlace.getString("reference");
			...
			place.put("placeId", place_id);
			place.put("reference", place_ref);
		} catch (JSONException e) {			
			e.printStackTrace();
		}		
		return place;
